...
\begin{document}
	...
	\begin{table}[htbp!]
		...
		\begin{tabular}{ |c|c|c|c| }
			...
			\hline
			Среднее & \( 4.753 \times 10^{-2} \) & \( 4.022 \times 10^{-2} \) &
			\( 3.168 \times 10^{-2} \) \\
			\hline
			Среднее квадратов & \(5.626 \times 10^{-2} \) &
			\( 5.494 \times 10^{-2} \) & \( 1.053 \times 10^{-1} \) \\
			\hline
			Дисперсия & \( 5.400 \times 10^{-2} \) &
			\( 5.332 \times 10^{-2} \) & \( 1.043 \times 10^{-1} \) \\
			\hline
			\hline
			\( n = 20 \), \( \rho = 0.5 \) & & & \\
			\hline
			...
			\( r_Q \) \eqref{eq:quadrant_corr} \\
			\hline
			Среднее & \( 4.885 \times 10^{-2} \) & \( 4.581 \times 10^{-2} \) &
			\( 4.139 \times 10^{-2} \) \\
			\hline
			Среднее квадратов & \(1.864 \times 10^{-2} \) &
			\( 1.859 \times 10^{-2} \) & \( 3.370 \times 10^{-2} \) \\
			\hline
			Дисперсия & \( 1.625 \times 10^{-2} \) &
			\( 1.649 \times 10^{-2} \) & \( 3.198 \times 10^{-2} \) \\
			\hline
			\hline
			\( n = 60 \), \( \rho = 0.5 \) & & & \\
			\hline
			...
			\( r_Q \) \eqref{eq:quadrant_corr} \\
			\hline
			Среднее & \( 4.620 \times 10^{-2} \) & \( 4.284 \times 10^{-2} \) &
			\( 3.773 \times 10^{-2} \) \\
			\hline
			Среднее квадратов & \(1.251 \times 10^{-2} \) &
			\( 1.197 \times 10^{-2} \) & \( 2.182 \times 10^{-2} \) \\
			\hline
			Дисперсия & \( 1.038 \times 10^{-2} \) &
			\( 1.013 \times 10^{-2} \) & \( 2.040 \times 10^{-2} \) \\
			\hline
			\hline
			\( n = 100 \), \( \rho = 0.5 \) & & & \\
			\hline
